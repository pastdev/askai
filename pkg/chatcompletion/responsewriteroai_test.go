...
func TestResponseWriterOai(t *testing.T) {
	tester := func(
		t *testing.T,
		wFac func(io.Writer) chatcompletion.ResponseWriterOai,
		res *oai.ChatCompletion,
		sres []oai.ChatCompletionChunk,
	...
	contentFac := func(w io.Writer) chatcompletion.ResponseWriterOai {
		return &chatcompletion.ContentResponseWriterOai{W: w}
	}
	...
	rawFac := func(w io.Writer) chatcompletion.ResponseWriterOai {
		return &chatcompletion.RawResponseWriterOai{W: w}
	}
	...
	resFac := func(t *testing.T, raw string) (*oai.ChatCompletion, string) {
		var res oai.ChatCompletion
	...
	resStreamFac := func(t *testing.T, raw string) ([]oai.ChatCompletionChunk, string) {
		var res []oai.ChatCompletionChunk
		err := json.Unmarshal([]byte(raw), &res)
		require.NoError(t, err)
